      ...
      {!user ? (
        ...
        <>
          ...
          <Route
            ...
            element={loadLayout(AdminLayout, Calendar)}
          />
          <Route
            path="/admin/archivos"
            element={loadLayout(AdminLayout, Files_c)}
          />
          <Route
            path="/admin/recordatorios"
            element={loadLayout(AdminLayout, Recordatorios_)}
          />
          <Route
            path="/admin/configuracion"
            element={loadLayout(AdminLayout, Configuracion)}
          />
          <Route
            path="/admin/planes"
            element={loadLayout(AdminLayout, Planes)}
          />
        </>
      )}
    </Routes>
